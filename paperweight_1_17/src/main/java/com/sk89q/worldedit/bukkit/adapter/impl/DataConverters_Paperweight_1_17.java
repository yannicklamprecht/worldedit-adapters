...
class DataConverters_Paperweight_1_17 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    static DataConverters_Paperweight_1_17 INSTANCE;
    ...
    DataConverters_Paperweight_1_17(int dataVersion, Spigot_Paperweight_1_17 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private net.minecraft.nbt.CompoundTag convert(LegacyType type, net.minecraft.nbt.CompoundTag cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_Paperweight_1_17.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_Paperweight_1_17.this.inspectors.get(type);
    ...
    private static class DataInspectorEntity implements DataInspector {
        ...
        private static final Logger a = LogManager.getLogger(DataConverters_Paperweight_1_17.class);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        net.minecraft.nbt.CompoundTag inspectChecked(net.minecraft.nbt.CompoundTag compoundTag, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_Paperweight_1_17.convertItems(compoundTag, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        net.minecraft.nbt.CompoundTag inspectChecked(net.minecraft.nbt.CompoundTag compoundTag, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_Paperweight_1_17.convertItem(compoundTag, key, sourceVer, targetVer);
            }
            ...
            if ("minecraft:written_book".equals(cmp.getString("id"))) {
                ...
                if (compoundTag1.contains("pages", 9)) {
                    ...
                    for (int i = 0; i < nbttaglist.size(); ++i) {
                        ...
                        nbttaglist.add(i, StringTag.valueOf(Component.Serializer.toJson((Component) object)));
                    }
    ...
    private static class DataConverterSignText implements DataConverter {
        ...
        private void convert(net.minecraft.nbt.CompoundTag compoundTag, String s) {
            ...
            compoundTag.putString(s, Component.Serializer.toJson((Component) object));
        }
    }
